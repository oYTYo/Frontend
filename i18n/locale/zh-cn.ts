export default {
  ...
  home: {
    ...
    pressure: '仪表盘',
    onlineDevices: '在线设备数',
    onlineCustomers: '总设备数',
    activeStreams: '活跃流数',
    systemHealthScore: '系统健康分数'
  },
  system: {
    dict: {
      label: '数据字典',
    ...
    dept: {
      label: '部门',
      add: '@:system.dept.label@:common.add',
      edit: '@:system.dept.label@:common.edit',
      detail: '@:system.dept.label@:common.detail',
      code: '部门代码',
      name: '部门名称',
      parentId: '上级部门Id',
      parentName: '上级部门名称',
    ...
    qoe: {
      label: 'QoE管理',
      add: '@:system.qoe.label@:common.add',
      edit: '@:system.qoe.label@:common.edit',
      detail: '@:system.qoe.label@:common.detail',
      ipcNumber: 'IPC编号',
      streamId: '流ID',
      ipAddress: 'IP地址',
      deviceName: '设备名称',
